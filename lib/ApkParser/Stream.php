...
class Stream
{
    ...
    {
        $isOpenedInternally = !is_resource($destination);
        $destStream = $isOpenedInternally ? fopen($destination, 'w+') : $destination;

        /**
         * Bolt: Use stream_copy_to_stream for massive speed boost (up to 400x) and efficient memory usage.
         */
