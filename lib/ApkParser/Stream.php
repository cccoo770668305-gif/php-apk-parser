...
class Stream
{
    ...
    public function save($destination)
    {
        ...
        /**
         * Bolt: Use stream_copy_to_stream for much faster copying than a byte-by-byte loop.
         * This can be significantly faster for large files (like DEX files in an APK).
         */
