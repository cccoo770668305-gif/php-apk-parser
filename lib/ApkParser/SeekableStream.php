...
class SeekableStream
{
    ...
    private static function toMemoryStream($stream, $length = 0)
    {
        ...
        /**
         * Bolt: Optimized iterative buffer loop with stream_copy_to_stream.
         * This is significantly faster for non-seekable streams and correctly
         * respects the length limit without manual seeking.
         */
        if ($length > 0) {
