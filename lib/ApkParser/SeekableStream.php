...
class SeekableStream
{
    ...
    {
        /**
         * Bolt: Optimized stream copying using native stream_copy_to_stream.
         * This is faster than a manual loop and correctly handles non-seekable
         * source streams by not over-reading and attempting to fseek back.
         */
