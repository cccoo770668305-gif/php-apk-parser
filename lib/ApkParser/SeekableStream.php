...
class SeekableStream
{
    ...
    private static function toMemoryStream($stream, $length = 0)
    {
        ...
        /**
         * Bolt: Use stream_copy_to_stream to maximize throughput and minimize memory usage.
         * This also avoids fseek() calls which fail on non-seekable source streams (like zip).
         */
        if ($length > 0) {
