...
class SeekableStream
{
    ...
    private static function toMemoryStream($stream, $length = 0)
    {
        ...
        /**
         * Bolt: Optimized 128-byte buffer loop with stream_copy_to_stream.
         * This is significantly faster for large streams and avoids a bug where
         * fseek would be called on non-seekable streams if the buffer read
