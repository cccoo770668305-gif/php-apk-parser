...
class SeekableStream
{
    ...
    private static function toMemoryStream($stream, $length = 0)
    {
        ...
        /**
         * Bolt: Use stream_copy_to_stream for faster and cleaner stream-to-stream copying.
         * The $length parameter is correctly handled by the native function, which is
         * more efficient than a manual loop with a 128-byte buffer.
         */
        if ($length > 0) {
