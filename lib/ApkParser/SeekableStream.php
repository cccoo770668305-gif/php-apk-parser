...
class SeekableStream
{
    ...
    private static function toMemoryStream($stream, $length = 0)
    {
        ...
        /**
         * Bolt: Use stream_copy_to_stream for much faster data copying and better handling of non-seekable streams.
         * For $length = 0 (default), it copies the entire remaining stream.
         */
        if ($length > 0) {
