...
class SeekableStream
{
    ...
    private static function toMemoryStream($stream, $length = 0)
    {
        ...
        /**
         * Bolt: Replaced iterative 128-byte buffer loop with native stream_copy_to_stream.
         * This handles $length natively and correctly handles non-seekable source streams
         * by not needing to fseek back when a length limit is reached.
         */
        if ($length > 0) {
