...
class Parser
{
    ...
    public function getClasses()
    {
        ...
        $jarPath = escapeshellarg($this->config->jar_path);
        $cacheFolder = escapeshellarg($cache_folder);
        $dexFile = escapeshellarg($dex_file);
        $command = "java -jar {$jarPath} -d {$cacheFolder} {$dexFile}";
