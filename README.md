...
PHP 8.0+  
PHP 7.3+ is in [2.x.x](https://github.com/evozi/apk-parser-php/tree/v2.x.x) branch

### Installation

- Install [composer](http://getcomposer.org/download/)
- Run the following command in the folder where `composer.json` is: `composer require evozi/apk-parser-php`
...
[Thanks to all contributers](https://github.com/evozi/apk-parser-php/graphs/contributors)
